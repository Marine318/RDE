...
def get_args():
    ...
    ######################## CCL loss settings ########################
    parser.add_argument("--ccl_method", type=str, default='log', help="CCL method: ['log', 'tan', 'abs', 'exp', 'gce', 'infoNCE']")
    parser.add_argument("--ccl_q", type=float, default=0.5, help="CCL q parameter for GCE loss")
    parser.add_argument("--ccl_ratio", type=float, default=0.3, help="CCL ratio for selecting negative samples")
