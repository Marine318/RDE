...
def get_args():
    ...
    parser.add_argument("--lr_cost", default=1e-4, type=float, help="learning rate for cost function")
    parser.add_argument("--queue_length", default=128, type=int, help="image queue length")
    parser.add_argument("--rho", default=0.5, type=float, help="transport regularization parameter")
    parser.add_argument("--reg", default=0.01, type=float, help="optimal transport regularization")
    parser.add_argument("--use_cost_function", default=False, action='store_true', help="whether to use cost function")
    
    ######################## L2RM integration settings ########################
    parser.add_argument("--use_l2rm_noisy_loss", default=False, action='store_true', help="whether to use L2RM noisy loss")
    parser.add_argument("--l2rm_loss_weight", default=1.0, type=float, help="weight for L2RM noisy loss")
    parser.add_argument("--noise_ratio", default=0.0, type=float, help="noise ratio for optimal transport")
